...
import CS from '../../Images/engineering.jpg';
...
const CsUni = () => {
    ...
    useEffect(() => {
      ...
      const loadeng = async () => {
        const result = await axios.get("http://localhost:5000/universities?department=eng");
        seteng(result.data);
      };

    return ( 
        <div>
            <Title title="Universities & Degrees" sub="Related to Engineering" bg={CS} />
