...
import CS from '../../Images/cs_bg.jpg';
...
const CsUni = () => {
    ...
    useEffect(() => {
      ...
      const loadcs = async () => {
        const result = await axios.get("http://localhost:5000/universities?department=CS");
        setcs(result.data);
      };

    return ( 
        <div>
            <Title title="Universities & Degrees" sub="Related to Computer Science" bg={CS} />
